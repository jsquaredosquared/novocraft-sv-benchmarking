# TODO: Make sure they are downloaded to the correct directory.

# Get HG002 FASTQ files
# Note: There may be a faster way to do this, e.g. Amazon's CLI.
